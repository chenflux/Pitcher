...
export const THEMES: ThemeInfo[] = [
  {
    id: "tranquil", name: "静谧", desc: "深邃暗蓝，青色点缀", className: "theme-tranquil",
...
function applyThemeClass(themeName: ThemeName) {
  ...
  if (info?.className) {
    ...
    document.documentElement.classList.add("theme-tranquil");
  }
}
...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  const info = THEMES.find((t) => t.id === theme) ?? THEMES[6];
